...
$query = mysqli_query($con,"SELECT * FROM `users` WHERE `key`='".$key."' and `email`='".$email."';");
...
<p><a href="https://vtsgirls.proj.vts.su.ac.rs/adoption/login/forgotpassword/index.php">Click here</a> to reset password.</p>';
	}else{
...
<p><a href="https://vtsgirls.proj.vts.su.ac.rs/adoption/login/index.php">Click here</a> to Login.</p></div><br />';
		}		
}
?>
